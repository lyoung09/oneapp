...
class Coupon extends StatefulWidget {
  ...
  Coupon(this.userId, this.userName);

  @override
  _CouponState createState() => _CouponState(this.userId, this.userName);
}
...
class _CouponState extends State<Coupon> {
  ...
  var futurePoint;
  int _value = 1;
  _CouponState(this.userId, this.userName);
  ...
  //   final shopList = await userPoint.getCouponEntire();
  //   setState(() {
  //     point = shopList.list;
  //   });
  // }
