...
Future<Map<String, dynamic>> getFavorite(String userChk) async {
  ...
  http.Response response = await http.post(
    ...
    Uri.encodeFull('http://192.168.0.47:8080/getFavorite'),
...
Future<Favorite> getFavoriteEntire() async {
  ...
  final response = await http.get('http://192.168.0.47:8080/getFavorite');
...
Future<SaveF> saveFavoriteShop(
  ...
  http.Response response = await http.post(
    Uri.encodeFull('http://192.168.0.47:8080/insertFavorite'),
    headers: {"Accept": "application/json"},
    body: bodyParam,
  );
...
Future<DeleteF> deleteFavoriteShop(
  ...
  http.Response response = await http.post(
    Uri.encodeFull('http://192.168.0.47:8080/deleteFavorite'),
    headers: {"Accept": "application/json"},
    body: bodyParam,
  );
